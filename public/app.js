...
let tipPercentageButtons = document.querySelectorAll(`.tipPercentage`);
let customTipInput = document.getElementById("customTip");
let errorMsg = document.getElementById(`errorMsg`);
let peopleCountInput = document.getElementById("peopleCount");
let tipPerPersonDisplay = document.getElementById("tipPerPerson");
let totalPerPersonDisplay = document.getElementById("totalPerPerson");
...
function calculate() {
    ...
    if (validate(values)) {
        ...
        const totalAmountPerPerson = values.numberOfPeople > 0
